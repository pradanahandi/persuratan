							...
							<fieldset>
								...
								<section hidden="">
									<label class="input"> <i class="icon-append fa fa-envelope-o"></i>
										<input type="text" name="no_m" placeholder="No Urut MoA" value="<?php echo $x;?>">
										<b class="tooltip tooltip-bottom-right">No Urut MoA</b> </label>
								</section>

								<section>
									<label class="input"> <i class="icon-append fa fa-envelope-o"></i>
										<input type="text" name="nomoa" placeholder="No MoA" value="<?php echo $nomoa;?>">
										<b class="tooltip tooltip-bottom-right">Masukan No MoA</b> </label>
								</section>
